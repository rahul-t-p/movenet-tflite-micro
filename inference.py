...
IMG_PATH = "tests/000000000785.jpg"
...
print(tflm_interpreter.print_allocations())
...
keypoints_with_scores = tflm_interpreter.get_output(0)
...
plt.imsave("output.png", output_overlay)
